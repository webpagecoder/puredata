...
import PathReference  from './entities/reference/PathReference.js';
import ObjectUtils  from './utils/ObjectUtils.js';
import Enum  from './entities/Enum.js';
import BooleanChain  from './entities/chains/BooleanChain.js';
import ArrayChain  from './entities/chains/ArrayChain.js';
import DateChain  from './entities/chains/DateChain.js';
import ObjectChain  from './entities/chains/ObjectChain.js';
import NumberChain  from './entities/chains/NumberChain.js';
import GenericChain  from './entities/chains/GenericChain.js';
import SchemaChain  from './entities/chains/SchemaChain.js';
import StringChain  from './entities/chains/StringChain.js';

import CompiledEntity  from './entities/CompiledEntity.js';
import CompiledSchemaChain  from './entities/chains/CompiledSchemaChain.js';

import ConditionalEntity  from './entities/ConditionalEntity.js';
import SchemaConditionalEntity  from './entities/SchemaConditionalEntity.js';
...
import CompilationMapper  from './entities/CompilationMapper.js';
import StaticValue  from './entities/values/StaticValue.js';
import EntityReference  from './entities/EntityReference.js';
