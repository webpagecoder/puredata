...
class NumberChain extends Chain {
    ...
    clampBetween(min, max) {
        return this.addStep('clampBetween', [min, max]);
    }
    ...
    roundDown() {
        return this.addStep('roundDown');
    }

    roundUp() {
        return this.addStep('roundUp');
    }

    stripSign() {
        return this.addStep('stripSign');
    }
    ...
    toPower(exponent) {
        return this.addStep('toPower', [exponent]);
    }

    toScale(fromMin, fromMax, toMin, toMax) {
        return this.addStep('toScale', [fromMin, fromMax, toMin, toMax]);
    }
