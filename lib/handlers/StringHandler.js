...
class StringHandler extends GenericHandler {
    ...
    static ipCidrV4(str) {
        ...
        return num !== null && this.prototype.ipV4(parts[0]).pass && NumberHandler.between(num, 0, 32).pass
            ? pass(str)
    ...
    static ipCidrV6(str) {
        ...
        const num = NumberUtils.toNumber(parts[1]);
        return num !== null && this.prototype.ipV6(parts[0]).pass && NumberHandler.between(num, 0, 128).pass
            ? pass(str)
