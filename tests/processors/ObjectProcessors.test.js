...
import ObjectHandler  from '../../lib/processors/ObjectHandler.js';
import Path  from '../../lib/Path.js';

// Note: ObjectHandler does not have an isObject method
// Use GenericHandler.isPrimitive(value, 'object') for type checking

describe('ObjectHandler.isEmpty', () => {
    it('should pass for empty objects', () => {
        const result = ObjectHandler.isEmpty({});
    ...
    it('should fail for objects with keys', () => {
        const obj = { a: 1 };
        const result = ObjectHandler.isEmpty(obj);
    ...
    it('should pass for new Object() with no properties', () => {
        const result = ObjectHandler.isEmpty(new Object());
        expect(result.pass).toBe(true);
    });
});

describe('ObjectHandler.isNotEmpty', () => {
    it('should pass for objects with keys', () => {
        const obj = { a: 1 };
        const result = ObjectHandler.isNotEmpty(obj);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual(obj);
    });
    ...
    it('should fail for empty objects', () => {
        const result = ObjectHandler.isNotEmpty({});
        expect(result.pass).toBe(false);
        expect(result.value).toEqual({});
    });
...
describe('ObjectHandler.hasProperty', () => {
    it('should pass when property exists', () => {
        const obj = { foo: 'bar' };
        const result = ObjectHandler.hasProperty(obj, 'foo');
        expect(result.pass).toBe(true);
        expect(result.value).toEqual(obj);
    });
    ...
    it('should fail when property does not exist', () => {
        const obj = { foo: 'bar' };
        const result = ObjectHandler.hasProperty(obj, 'baz');
        expect(result.pass).toBe(false);
    });
    ...
    it('should fail when object is null', () => {
        const result = ObjectHandler.hasProperty(null, 'foo');
        expect(result.pass).toBe(false);
    });

    it('should fail when object is undefined', () => {
        const result = ObjectHandler.hasProperty(undefined, 'foo');
        expect(result.pass).toBe(false);
    });
...
describe('ObjectHandler.isPlainObject', () => {
    it('should pass for plain objects', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.isPlainObject(obj);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual(obj);
    });

    it('should pass for empty objects', () => {
        const result = ObjectHandler.isPlainObject({});
        expect(result.pass).toBe(true);
    });

    it('should fail for arrays', () => {
        const result = ObjectHandler.isPlainObject([1, 2, 3]);
        expect(result.pass).toBe(false);
    });

    it('should fail for class instances', () => {
        class MyClass {}
        const result = ObjectHandler.isPlainObject(new MyClass());
        expect(result.pass).toBe(false);
    });

    it('should fail for Date objects', () => {
        const result = ObjectHandler.isPlainObject(new Date());
        expect(result.pass).toBe(false);
    });

    it('should fail for RegExp objects', () => {
        const result = ObjectHandler.isPlainObject(/test/);
        expect(result.pass).toBe(false);
    });

    it('should fail for primitives', () => {
        expect(ObjectHandler.isPlainObject('string').pass).toBe(false);
        expect(ObjectHandler.isPlainObject(123).pass).toBe(false);
        expect(ObjectHandler.isPlainObject(true).pass).toBe(false);
        expect(ObjectHandler.isPlainObject(null).pass).toBe(false);
        expect(ObjectHandler.isPlainObject(undefined).pass).toBe(false);
    });
});

describe('ObjectHandler.removeEmpties', () => {
    it('should remove null and undefined by default', () => {
        const obj = { a: 1, b: null, c: undefined, d: 2 };
        const result = ObjectHandler.removeEmpties(obj);
    ...
    it('should remove custom empty values', () => {
        ...
        const result = ObjectHandler.removeEmpties(obj, ['', 0]);
        expect(result).toEqual({ a: 1, d: 2 });
    });
    ...
    it('should remove false when specified', () => {
        ...
        const result = ObjectHandler.removeEmpties(obj, [false]);
...
describe('ObjectHandler.removeEmptiesRecursive', () => {
    it('should remove null and undefined recursively', () => {
        ...
        const result = ObjectHandler.removeEmptiesRecursive(obj);
...
describe('ObjectHandler.removePaths', () => {
    it('should remove simple paths', () => {
        const obj = { a: 1, b: 2, c: 3 };
            const result = ObjectHandler.removePaths(obj, [Path.create('b', '.')]);
        expect(result.pass).toBe(true);
    ...
    it('should remove multiple paths', () => {
        const obj = { a: 1, b: 2, c: 3 };
            const result = ObjectHandler.removePaths(obj, [Path.create('a', '.'), Path.create('c', '.')]);
        expect(result.pass).toBe(true);
    ...
    it('should remove nested paths', () => {
        const obj = { a: { b: { c: 1 } } };
            const result = ObjectHandler.removePaths(obj, [Path.create('a.b.c', '.')]);
        expect(result.pass).toBe(true);
    ...
    it('should handle empty paths array', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.removePaths(obj, []);
        expect(result.pass).toBe(true);
    ...
    it('should modify the original object', () => {
        const obj = { a: 1, b: 2 };
            ObjectHandler.removePaths(obj, [Path.create('b', '.')]);
        expect(obj).toEqual({ a: 1 });
    });
});

describe('ObjectHandler.setPaths', () => {
    it('should set simple paths', () => {
        const obj = { a: 1 };
            const result = ObjectHandler.setPaths(obj, [[Path.create('b', '.'), 2]]);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual({ a: 1, b: 2 });
    });
    ...
    it('should set nested paths', () => {
        const obj = {};
            const result = ObjectHandler.setPaths(obj, [[Path.create('a.b.c', '.'), 123]]);
        expect(result.pass).toBe(true);
    ...
    it('should set multiple paths', () => {
        const obj = {};
            const result = ObjectHandler.setPaths(obj, [[Path.create('a', '.'), 1], [Path.create('b', '.'), 2], [Path.create('c', '.'), 3]]);
        expect(result.pass).toBe(true);
    ...
    it('should overwrite existing values by default', () => {
        const obj = { a: 1 };
            const result = ObjectHandler.setPaths(obj, [[Path.create('a', '.'), 2]]);
        expect(result.pass).toBe(true);
    ...
    it('should not overwrite when overwrite is false', () => {
        const obj = { a: 1 };
            const result = ObjectHandler.setPaths(obj, [[Path.create('a', '.'), 2]], false);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual({ a: 1 });
    });
    ...
    it('should create nested paths by default', () => {
        const obj = {};
            const result = ObjectHandler.setPaths(obj, [[Path.create('a.b.c', '.'), 123]], true, true);
        expect(result.pass).toBe(true);
    ...
    it('should modify the original object', () => {
        const obj = { a: 1 };
            ObjectHandler.setPaths(obj, [[Path.create('b', '.'), 2]]);
    ...
    it('should handle Map-like arrays of [path, value] pairs', () => {
        ...
        const result = ObjectHandler.setPaths(obj, valueMap);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual({
            name: 'John',
            age: 30,
...
describe('ObjectHandler.renameKeys', () => {
    it('should rename keys matching the regex', () => {
        const obj = { foo_1: 1, foo_2: 2, bar: 3 };
        const result = ObjectHandler.renameKeys(obj, /^foo_/, 'baz_');
        expect(result.pass).toBe(true);
    ...
    it('should not delete original keys if deleteOriginalKey is false', () => {
        ...
        const result = ObjectHandler.renameKeys(obj, /^a_/, 'b_', { deleteOriginalKey: false });
        expect(result.pass).toBe(true);
    ...
    it('should skip undefined values if ignoreUndefined is true', () => {
        ...
        const result = ObjectHandler.renameKeys(obj, /^foo_/, 'bar_', { ignoreUndefined: true });
        expect(result.pass).toBe(true);
    ...
    it('should not override existing keys if overrideExistingKey is false', () => {
        ...
        const result = ObjectHandler.renameKeys(obj, /^foo$/, 'bar', { overrideExistingKey: false });
        expect(result.pass).toBe(true);
    ...
    it('should override existing keys if overrideExistingKey is true', () => {
        const obj = { foo: 1, bar: 2 };
        const result = ObjectHandler.renameKeys(obj, /^foo$/, 'bar', { overrideExistingKey: true });
        expect(result.pass).toBe(true);
        expect(result.value).toEqual({ bar: 1 });
    });
});

describe('ObjectHandler.stripUnknownKeys', () => {
    it('should keep only known keys', () => {
        const obj = { a: 1, b: 2, c: 3 };
        const result = ObjectHandler.stripUnknownKeys(obj, ['a', 'c']);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual({ a: 1, c: 3 });
    });
    ...
    it('should include undefined values if includeUndefined is true', () => {
        ...
        const result = ObjectHandler.stripUnknownKeys(obj, ['a', 'b', 'c'], { includeUndefined: true });
        expect(result.pass).toBe(true);
    ...
    it('should skip undefined values if includeUndefined is false', () => {
        const obj = { a: 1, b: undefined, c: 3 };
        const result = ObjectHandler.stripUnknownKeys(obj, ['a', 'b', 'c'], { includeUndefined: false });
        expect(result.pass).toBe(true);
        expect(result.value).toEqual({ a: 1, c: 3 });
    });
    ...
    it('should return an empty object if no known keys are present', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.stripUnknownKeys(obj, ['x', 'y']);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual({});
    });

    it('should return an empty object if the input is not an object', () => {
        const result = ObjectHandler.stripUnknownKeys('not an object', ['a', 'b']);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual({});
    });
});
...
describe('ObjectHandler.instanceOf', () => {
    it('should pass if object is instance of given constructor', () => {
        ...
        const result = ObjectHandler.instanceOf(obj, MyClass);
        expect(result.pass).toBe(true);
    });
    ...
    it('should fail if object is not instance of given constructor', () => {
        ...
        function OtherClass() { }
        const obj = new MyClass();
        const result = ObjectHandler.instanceOf(obj, OtherClass);
        expect(result.pass).toBe(false);
    });

    it('should fail if input is not an object', () => {
        const result = ObjectHandler.instanceOf('not an object', Object);
        expect(result.pass).toBe(false);
    });
});
...
describe('ObjectHandler.pickRandom', () => {
    ...
    it('should return a copy of the object if count is greater than or equal to number of keys', () => {
        const obj = { x: 10, y: 20 };
        const result = ObjectHandler.pickRandom(obj, 5);
        expect(result.pass).toBe(true);
        expect(result.value).toEqual(obj);
    });
...
describe('ObjectHandler.maxDepth', () => {
    it('should pass if object depth is less than or equal to maxDepth', () => {
        ...
        const result = ObjectHandler.maxDepth(obj, 3);
        expect(result.pass).toBe(true);
    });
    ...
    it('should fail if object depth is greater than maxDepth', () => {
        ...
        const result = ObjectHandler.maxDepth(obj, 5);
        expect(result.pass).toBe(false);
    });
    ...
    it('should pass for a very deep but shallow object and maxDepth equal to depth', () => {
        ...
        const result = ObjectHandler.maxDepth(obj, 7);
        expect(result.pass).toBe(true);
    });
});
...
describe('ObjectHandler.minDepth', () => {
    it('should pass if object depth is greater than or equal to minDepth', () => {
        ...
        const result = ObjectHandler.minDepth(obj, 4);
        expect(result.pass).toBe(true);
    });
    ...
    it('should pass for a complex object with minDepth 5', () => {
        ...
        const result = ObjectHandler.minDepth(obj, 5);
        expect(result.pass).toBe(true);
    });
});
...
describe('ObjectHandler.depth', () => {
    ...
    it('should pass for a very deep object and correct depth', () => {
        ...
        const result = ObjectHandler.depth(obj, 8);
        expect(result.pass).toBe(true);
    });
});
...
describe('ObjectHandler.maxKeyCount', () => {
    it('should pass if object has keys less than or equal to maxKeyCount', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.maxKeyCount(obj, 2);
        expect(result.pass).toBe(true);
    });
...
describe('ObjectHandler.maxKeyCountRecursive', () => {
    it('should pass if total keys (recursive) are less than or equal to maxKeyCount', () => {
        ...
        const result = ObjectHandler.maxKeyCountRecursive(obj, 3);
        expect(result.pass).toBe(true);
    });
    ...
    it('should pass for flat object and maxKeyCountRecursive 2', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.maxKeyCountRecursive(obj, 2);
        expect(result.pass).toBe(true);
    });
    ...
    it('should handle deep nested objects', () => {
        ...
        const result = ObjectHandler.maxKeyCountRecursive(obj, 9);
        expect(result.pass).toBe(true);
        const failResult = ObjectHandler.maxKeyCountRecursive(obj, 8);
...
describe('ObjectHandler.minKeyCount', () => {
    it('should pass if object has keys greater than or equal to minKeyCount', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.minKeyCount(obj, 2);
        expect(result.pass).toBe(true);
    });
    ...
    it('should work with deep objects but only count top-level keys', () => {
        ...
        const result = ObjectHandler.minKeyCount(obj, 4);
        expect(result.pass).toBe(true);
    });
...
describe('ObjectHandler.minKeyCountRecursive', () => {
    it('should pass if total keys (recursive) are greater than or equal to minKeyCount', () => {
        const obj = { a: 1, b: { c: 2 } }; // 3 keys
        const result = ObjectHandler.minKeyCountRecursive(obj, 3);
        expect(result.pass).toBe(true);
    });
    ...
    it('should pass for flat object and minKeyCountRecursive 2', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.minKeyCountRecursive(obj, 2);
        expect(result.pass).toBe(true);
    });
    ...
    it('should handle deep nested objects with many keys', () => {
        ...
        const result = ObjectHandler.minKeyCountRecursive(obj, 10);
        expect(result.pass).toBe(true);
        const failResult = ObjectHandler.minKeyCountRecursive(obj, 11);
        expect(failResult.pass).toBe(false);
    });
});
...
describe('ObjectHandler.keyCount', () => {
    it('should pass if object has exactly keyCount keys', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.keyCount(obj, 2);
        expect(result.pass).toBe(true);
    });
    ...
    it('should work with deep objects but only count top-level keys', () => {
        const obj = { a: 1, b: { c: 2, d: 3 }, e: 4 };
        const result = ObjectHandler.keyCount(obj, 3);
        expect(result.pass).toBe(true);
    });
...
describe('ObjectHandler.keyCountRecursive', () => {
    it('should pass if total keys (recursive) equal keyCount', () => {
        const obj = { a: 1, b: { c: 2 } }; // 3 keys
        const result = ObjectHandler.keyCountRecursive(obj, 3);
        expect(result.pass).toBe(true);
    });
    ...
    it('should handle very deep and wide objects', () => {
        ...
        const result = ObjectHandler.keyCountRecursive(obj, 12);
        expect(result.pass).toBe(true);
        const failResult = ObjectHandler.keyCountRecursive(obj, 11);
        expect(failResult.pass).toBe(false);
    });
});
...
describe('ObjectHandler.noneOfPaths', () => {
    it('should pass if none of the specified paths exist', () => {
        ...
        const result = ObjectHandler.noneOfPaths(
            obj,
            [
                Path.create('x/y/z', '/'),
                Path.create('b/d/x', '/'),
    ...
    it('should pass for empty path list', () => {
        ...
        const result = ObjectHandler.noneOfPaths(obj);
        expect(result.pass).toBe(true);
    });
    ...
    it('should work with deep nested paths', () => {
        ...
        const failResult = ObjectHandler.noneOfPaths(
            obj,
            [
...
describe('ObjectHandler.someOfPaths', () => {
    it('should pass if at least one of the specified paths exists', () => {
        ...
        const result = ObjectHandler.someOfPaths(
            obj,
            [
                Path.create('b/d/e', '/'),
                Path.create('x/y/z', '/'),
...
describe('ObjectHandler.allOfPaths', () => {
    it('should pass if all specified paths exist', () => {
        ...
        const result = ObjectHandler.allOfPaths(
            obj,
            [
                Path.create('a/b/c', '/'),
                Path.create('d/e', '/'),
    ...
    it('should pass for a single deep path', () => {
        const obj = { x: { y: { z: { w: 5 } } } };
        const result = ObjectHandler.allOfPaths(obj, [Path.create('x/y/z/w', '/')]);
        expect(result.pass).toBe(true);
    });
});
...
describe('ObjectHandler.onlyPaths', () => {
    it('should pass if object only has the allowed paths', () => {
        ...
        const result = ObjectHandler.onlyPaths(
            obj,
            [
                Path.create('a/b/c', '/'),
                Path.create('d/e', '/'),
...
describe('ObjectHandler.pathsOtherThan', () => {
    it('should pass if at least one of the specified paths does not exist', () => {
        ...
        const result = ObjectHandler.pathsOtherThan(
            obj,
            [
                Path.create('a/b/c', '/'),
                Path.create('d/e', '/'),
    ...
    it('should not fail for empty path list', () => {
        const obj = { a: 1, b: 2 };
        const result = ObjectHandler.pathsOtherThan(obj);
        expect(result.pass).toBe(true);
    });
});
...
describe('ObjectHandler.xOfPaths', () => {
    it('should pass if exactly X of the specified paths exist', () => {
        ...
        const result = ObjectHandler.xOfPaths(
            obj,
            2,
            [
                Path.create('a/b/c', '/'),
...
describe('ObjectHandler.allOfButXOfPaths', () => {
    it('should pass if all but X of the specified paths exist', () => {
        ...
        const result = ObjectHandler.allOfButXOfPaths(
            obj,
            1,
            [
                Path.create('a/b/c', '/'),
